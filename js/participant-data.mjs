...
export const PARTICIPANT_CARDS = [
  ...
  },
  {
    ...
    data_source: 'Локальная папка JPG и регламент ОТК; доступ предоставлен учебной команде.',
    ...
    success_target: 'Не менее 14 правильных классификаций из 20 отложенных размеченных фото.',
    contact: 'Учебный контакт начальника ОТК: qa@example.org.',
    consultation_format: 'Консультации по видеосвязи по запросу команды.',
    feedback_process: 'Начальник ОТК сравнивает результат с разметкой и отвечает в течение дня.',
  },
  {
